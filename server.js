...
async function go() {
    let client = new MongoClient('mongodb+srv://todoAppUser:helen&chi812@cluster0.wtajr.mongodb.net/todoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic TmF6enk6d2lubmVy") {
    next()
  } else {
